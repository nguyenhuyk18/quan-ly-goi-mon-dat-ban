...
router.get('/api/v1/admin/avatar-staff/:id' , checkPermission('view_staff') , StaffController.getImageStaff);
...
router.get('/api/v1/admin/image-product/:id' , checkPermission('view_product') , ProductController.returnImageProduct);
...
// ward 
router.get('/api/v1/admin/ward' , checkPermission('view_ward') , WardController.getAll);
router.get('/api/v1/admin/ward/:id' , checkPermission('view_ward') , WardController.find);
router.get('/api/v1/admin/ward-by-district/:id_district' , checkPermission('view_ward') , WardController.getByDistrictID);


// district
router.get('/api/v1/admin/district' , checkPermission('view_district') , DistrictController.getAll);
router.get('/api/v1/admin/district/:id' , checkPermission('view_district') , DistrictController.find);
router.get('/api/v1/admin/district-by-province/:id_province' , checkPermission('view_district') , DistrictController.getByProvinceID);

// province 
router.get('/api/v1/admin/province' , checkPermission('view_province') , ProvinceController.getAll);
router.get('/api/v1/admin/province/:id' , checkPermission('view_province') , ProvinceController.find);
