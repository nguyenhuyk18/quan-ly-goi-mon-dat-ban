class customer {
    ...
    constructor(id : number = null, name : string = null, phone : string = null, email : string = null, ward_id : string = null, created_date : string = null, status : number = null, housenumber_street : string = null, shipping_name : string = null, shipping_mobile : string = null, password : string = null, username : string = null) {
        this.id = id;
        this.name = name;
        this.phone = phone;
        this.email = email;
    ...
    getterShippingName() : string {
        return this.shipping_name;
    }

    getterShippingMobile() : string {
    ...
    setterShippingName(shipping_name : string) : void {
        this.shipping_name = shipping_name;
    }

    setterShippingMobile(shipping_mobile : string) : void {
        this.shipping_mobile = shipping_mobile;
    }
